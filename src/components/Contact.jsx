  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        <form action="https://getform.io/f/nbdodjya" method="POST" className='flex flex-col max-w-[600px] w-full'>
            ...
            <button className='text-white border-2 hover:bg-pink-600 hover:border-pink-600 px-3 py-2 sm:px-4 sm:py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
        </form>
    </div>
  )
}
